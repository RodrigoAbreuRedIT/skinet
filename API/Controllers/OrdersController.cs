...
namespace API.Controllers {
    ...
    public class OrdersController : BaseApiController {
        ...
        public async Task<ActionResult<Order>> CreatOrder(OrderDto orderDto){
            ...
            var order = await this._orderService.CreatOrderAsync(email, orderDto.DeliveryMethodId, orderDto.BasketId, address);
        ...
        public async Task<ActionResult<IReadOnlyList<DeliveryMethod>>> GetDeliveryMethods(){
            return Ok(await this._orderService.GetDeliveryMethodsAsync());
        }
    }
}